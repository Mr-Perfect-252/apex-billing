...
/**
 * Auth is delegated entirely to Clerk's hosted <SignIn /> component rather
 * than a hand-built form, per the product decision to use Clerk's built-in
 * UI. `appearance` reskins it to the app's pure black/white system so it
